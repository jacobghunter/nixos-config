...
in
{
  ...
  config = {
    ...
    wayland.windowManager.hyprland = {
      ...
      extraConfig =
        builtins.replaceStrings
          ...
          (builtins.readFile "${inputs.self}/nixos-shared/modules/hyprland/hyprland.lua");
    };
    ...
    xdg.configFile."hypr/nix-vars.lua".text = ''
      -- THIS FILE IS AUTOGENERATED BY NIX. DO NOT EDIT.

      return {
        -- System Theme / UI
        activeBorderColors = { "${toRgbaDef primary}", "${toRgbaDef secondary}" },
        activeBorderAngle = ${gradientDegrees},
        specialBorderColors = { "${toRgbaDef primary}", "${toRgbaDef special}" },
        specialBorderAngle = ${gradientDegrees},
        ...
        -- Injected Nix Paths
        wallpaperPath = "${staticWallpaper}",
        rofiMenu = "${pkgs.rofi}/bin/rofi -show drun -show-icons",
