        ...
        Row {
            ...
            Repeater {
                ...
                Rectangle {
                    ...
                    height: 26
                    radius: 6
                    color: workspaceRect.modelData.id === (Hyprland.focusedWorkspace ? Hyprland.focusedWorkspace.id : 0) ? "#b4befe" // Lavender
                    : "#1e1e2e" // Surface

                    border.color: workspaceRect.modelData.id === (Hyprland.focusedWorkspace ? Hyprland.focusedWorkspace.id : 0) ? "#b4befe" : "#313244"
                    border.width: 1

                    Text {
                        anchors.centerIn: parent
                        text: workspaceRect.modelData.id
                        color: workspaceRect.modelData.id === (Hyprland.focusedWorkspace ? Hyprland.focusedWorkspace.id : 0) ? "#11111b" : "#bac2de"
                        font.bold: true
                        font.pixelSize: 12
